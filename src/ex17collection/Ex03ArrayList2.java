...
public class Ex03ArrayList2 {
	...
	public static void main(String[] args) {
		...
		/*
		인스턴스의 참조값을 통해 삭제하는 경우 bollean값이 반환
		된다. 또한 동일한 이스턴스가 존재한다면 앞에서 부터 순서대
		...
		/*
		List에 저장된 값을 통해 이토레이터 인스턴스를 생성한다.
