...
class MyStatic {
	...
	/*
	인스턴트형 멤버메서드: 인스턴스형 메서드에서는 모든 멤버를 사용할
	...
	static void staticMethod() {
		//System.out.println("instanceVar="+ instanceVar);//애러
		System.out.println("staticVar="+ staticVar);
		//instanceMethod();//애러
	}
}
...
public class E01StaticModifier {
	...
	public static void main(String[] args) {
		...
		/*
		하지만 정적변수는 메모리(method)에 딱 하나만 생성되므로
