...
class MyParent {
	int paperMember;
	void parentMethod() {
		System.out.println("부모의메소드:parentMathod()");
	}
}
...
class MyChild extends MyParent{
	...
	/*
	메서드명은 동일하지만 매개변수가 다르므로 오버로딩으로 정의한 메서드.
	따라서 자식에서 확장한 멤버가된다. */
