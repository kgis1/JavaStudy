...
public class Ex02Priority {
	...
	public static void main(String[] args) {
		...
		정수로 부여해도 된다. */
//		MessageSendingThread tr1 = new MessageSendingThread.MAX_PRIORITY("첫번째");
//		MessageSendingThread tr2 = new MessageSendingThread.NORM_PRIORITY("두번째");
//		MessageSendingThread tr3 = new MessageSendingThread.MIN_PRIORITY("세번째");
